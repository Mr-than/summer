package com.example.summerassessment.ui.ffactivity
...
import com.example.summerassessment.ui.adapter.followfanadapter.FollowFanAdapter
import com.example.summerassessment.ui.adapter.followfanadapter.FollowFanRvAdapter
...
class FollowsFansActivity : AppCompatActivity() {
    ...
    private val viewModel:FollowsFansViewModel by lazy { ViewModelProvider(this).get(FollowsFansViewModel::class.java) }
