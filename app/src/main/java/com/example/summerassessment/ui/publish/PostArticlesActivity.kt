package com.example.summerassessment.ui.publish
...
import com.example.summerassessment.ui.publish.viewmodel.PostActivityViewModel
...
class PostArticlesActivity : WindowActivity() {
    ...
    private val viewModel: PostActivityViewModel by lazy {
        ViewModelProvider(this).get(
            PostActivityViewModel::class.java
        )
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.activityPostJokeImgViewUncheckImg.setOnClickListener {
            isPostImg = false
            binding.activityPostJokeImgViewCheckedImg.setImageResource(R.drawable.img_empty)
        ...
        binding.activityPostJokeEditText.addTextChangedListener(object :TextWatcher{
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {

            }

            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                binding.activityPostJokeEditTextNum.text=binding.activityPostJokeEditText.text.toString().length.toString()
            }
            ...
            CHOOSE_PHOTO -> {
                ...
                if (resultCode == RESULT_OK) {
                    try {
                        ...
                        binding.activityPostJokeImgViewCheckedImg.setImageBitmap(
                            rotateIfRequired(
                                bitmap
                            )
                        )
