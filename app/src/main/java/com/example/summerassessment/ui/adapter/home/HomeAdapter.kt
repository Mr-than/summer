...
import com.example.summerassessment.ui.dialog.CommentPage
...
import com.example.summerassessment.ui.detail.DetailActivity
...
open class HomeAdapter(
    ...
    private val viewModel: HomeFragmentViewModel = ViewModelProvider(context)[HomeFragmentViewModel::class.java]
    ...
    open fun update(i: Boolean, recyclerView: RecyclerView?=null) {
